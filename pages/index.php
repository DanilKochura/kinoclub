...
foreach($meetings as $m):
	?>
  	<div class="row"> '<div class="three"><h1>Заседание #<?=$m['num']+1?></h1></div></div>
  		...
  		<div class="row">
  			<div class="col-md-2 poster"><a href="<?=$m['url'];?>"><img src="<?=ROOT?><?=$m['poster'];?>" class="img-fluid rounded"id="IM"></a></div>
  			<div class="col-md-4 text-left description">
		  		...
		  		<div class="rates"><table class="table-rate text-center">
       			<thead>
            	<tr>
                <th scope="col"><img src="<?=ROOT?>image/imdb.png" class="res_logo"></th>
                <th scope="col"><img src="<?=ROOT?>image/kp.png" class="res_logo"></th>
                <th scope="col"><img src="<?=ROOT?>image/logogo.png" class="res_logo"></th>
                </tr>
                </thead>
                <tbody>
                <tr>
                ...
                <?php for($i; $i<$n/2; ++$i): ?>
                    <td scope="row"  class="ex-name">
                        <a href="../profile/<?=$m['rates'][$i]['id']?>">
                            <img  src="<?=ROOT?>uploads\<?=$m['rates'][$i]['avatar']?>" alt="Ваня" class="avatar">
                        </a>
                    </td>
                    <?php endfor; ?>
                </tr>
